...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests()
                ...
                .antMatchers(HttpMethod.POST, "/customers/{id}/projects").hasAnyAuthority("ADMIN","BOOKKEEPER")
                ...
                .antMatchers(HttpMethod.DELETE,"/projects/{id}").hasAnyAuthority("BOOKKEEPER","ADMIN")
                ...
                .antMatchers("/api/invoice/export/excel").hasAnyAuthority("BOOKKEEPER", "ADMIN")
                ...
                .antMatchers("/api/invoice/export/pdf").hasAnyAuthority("BOOKKEEPER", "ADMIN")
                .antMatchers("/api/invoice/export/xml").hasAnyAuthority("BOOKKEEPER", "ADMIN")
